...
*Possible scenario of Nuclear installation
...
*Water technologies
        RIVER 'river source of fresh water'
        SEA   'sea source of salt water'
        DELTA 'conversion from fresh to salt water'
/;
...
set power_plants(TECHNOLOGY) /BFHPFH1, BMCCPH1, BMCHPH3, BMSTPH3, BMCSPN2, COCHPH3, COSTPH1, COSTPH3, GOCVPH2, HFCCPH2, HFCHPH3, HFGCPH3, HFGCPN3, HFSTPH2, HFSTPH3, HFHPFH1, HFHPPH2,
...
set secondary_production(TECHNOLOGY) /BFHPFH1, BMCCPH1, BMCHPH3, BMSTPH3, BMCSPN2, COCHPH3, COSTPH1, COSTPH3, GOCVPH2, HFCCPH2, HFCHPH3, HFGCPH3, HFGCPN3, HFSTPH2, HFSTPH3, HFHPFH1, HFHPPH2,
...
*------------------------------------------------------------------------
* Parameters - Global (adapted from OSeMBE)
*------------------------------------------------------------------------
...
*river capacity
    CapacityFactor(r,'RIVER','S01B1',y) = 1.004491823;
    CapacityFactor(r,'RIVER','S01B2',y) = 1.004491823;
    CapacityFactor(r,'RIVER','S01B3',y) = 1.004491823;
    CapacityFactor(r,'RIVER','S02B1',y) = 1.067994179;
    CapacityFactor(r,'RIVER','S02B2',y) = 1.067994179;
    CapacityFactor(r,'RIVER','S02B3',y) = 1.067994179;
    CapacityFactor(r,'RIVER','S03B1',y) = 0.935216525;
    CapacityFactor(r,'RIVER','S03B2',y) = 0.935216525;
    CapacityFactor(r,'RIVER','S03B3',y) = 0.935216525;
    CapacityFactor(r,'RIVER','S04B1',y) = 1.148815361;
    CapacityFactor(r,'RIVER','S04B2',y) = 1.148815361;
    CapacityFactor(r,'RIVER','S04B3',y) = 1.148815361;
    CapacityFactor(r,'RIVER','S05B1',y) = 1.073767121;
    CapacityFactor(r,'RIVER','S05B2',y) = 1.073767121;
    CapacityFactor(r,'RIVER','S05B3',y) = 1.073767121;
   
*Solar capacity (given in OSeMBE)
...
*Sea water cooled plants, implemented by us
...
*Nuclear possibly is ready for 2036 
...
*------------------------------------------------------------------------
* Parameters - Technology costs (mainly given by OSeMBE)
*------------------------------------------------------------------------
parameter CapitalCost /
    ...
    ITALY.WIOFPN3.2015    2725.1370704
    ITALY.WIOFPN3.2016    2632.4667032
    ITALY.WIOFPN3.2017    2539.796336
    ITALY.WIOFPN3.2018    2447.1259688
    ITALY.WIOFPN3.2019    2354.4556016
    ITALY.WIOFPN3.2020    2261.7852344
    ITALY.WIOFPN3.2021    2238.2249712
    ITALY.WIOFPN3.2022    2214.6647088
    ITALY.WIOFPN3.2023    2191.1044456
    ITALY.WIOFPN3.2024    2167.5441832
    ITALY.WIOFPN3.2025    2143.98392
    ITALY.WIOFPN3.2026    2120.4236568
    ITALY.WIOFPN3.2027    2096.8633944
    ITALY.WIOFPN3.2028    2073.3031312  
    ...
    ITALY.WIONPH3.2036   995.8522664
    ITALY.WIONPH3.2037   987.82120
    ITALY.WIONPH3.2038   979.7901336
    ITALY.WIONPH3.2039   971.7590664
    ITALY.WIONPH3.2040   963.728
    ITALY.WIONPH3.2041   955.6969336
    ITALY.WIONPH3.2042   947.6658664
    ITALY.WIONPH3.2043   939.63480
    ITALY.WIONPH3.2044   931.6037336
    ITALY.WIONPH3.2045   923.5726664
    ITALY.WIONPH3.2046   915.5416
    ITALY.WIONPH3.2047   907.5105336
    ITALY.WIONPH3.2048   899.4794664
    ITALY.WIONPH3.2049   891.44840
    ITALY.WIONPH3.(2050*2060)   883.4173336
    ...
    ITALY.WIONPN3.2036  995.8522664
    ITALY.WIONPN3.2037  987.82120
    ITALY.WIONPN3.2038  979.7901336
    ITALY.WIONPN3.2039  971.7590664
    ITALY.WIONPN3.2040  963.728
    ITALY.WIONPN3.2041  955.6969336
    ITALY.WIONPN3.2042  947.6658664
    ITALY.WIONPN3.2043  939.63480
    ITALY.WIONPN3.2044  931.6037336
    ITALY.WIONPN3.2045  923.5726664
    ITALY.WIONPN3.2046  915.5416
    ITALY.WIONPN3.2047  907.5105336
    ITALY.WIONPN3.2048  899.4794664
    ITALY.WIONPN3.2049  891.44840
    ITALY.WIONPN3.(2050*2060)   883.4173336
...
*Higher cost for seaside plants
...
*Mesured in GW (or equivalent, for water km3/year)
...
*Minimum capacity according to PNIEC in 2030
*GW/year
...
*Only fossil emissions, biogenic carbon excluded (italian avarage)
    ITALY.WS00X00.CO2.1.(2015*2060)  0.00005

*Biomass and biofuel considered net zero
